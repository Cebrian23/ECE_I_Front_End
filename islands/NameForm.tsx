                    ...
                    <div class="row_buttons">
                        {
                            ...
                            <>
                                ...
                                <button type="button" onClick={() => location.href="/event/name/Events_name"}>Enviar</button>
                            </>
                        }
                        {
                            page_back === "People" &&
                            <>
                                ...
                                <button type="button" onClick={() => location.href="/person/name/People_name"}>Enviar</button>
                            </>
                        }
                        {
                            ...
                            <>
                                ...
                                <button type="button" onClick={() => location.href="/organization/name/Organizations_name"}>Enviar</button>
                            </>
                        }
                        {
                            page_back === "Literature" &&
                            <>
                                ...
                                <button type="button" onClick={() => location.href="/book/title/Books_title"}>Enviar</button>
                            </>
                        }
                        {
                            ...
                            <>
                                ...
                                <button type="button" onClick={() => location.href="/heraldry/name/Heraldries_name"}>Enviar</button>
                            </>
                        }
                        {
                            page_back === "Legends" &&
                            <>
                                ...
                                <button type="button" onClick={() => location.href="/legend/name/Legends_name"}>Enviar</button>
                            </>
                        }
                        {
                            ...
                            <>
                                ...
                                <button type="button" onClick={() => location.href="/festivity/name/Festivities_name"}>Enviar</button>
                            </>
                        }
                        {
                            page_back === "Monuments" &&
                            <>
                                ...
                                <button type="button" onClick={() => location.href="/monument/name/Monuments_name"}>Enviar</button>
                            </>
                        }
                    </div>
                </div>
